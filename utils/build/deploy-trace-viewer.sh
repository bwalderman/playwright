...
if [[ "${RELEASE_CHANNEL}" == "--stable" ]]; then
  ...
  cp -r packages/playwright-core/lib/cjs/webpack/traceViewer/* trace.playwright.dev/docs/
  ...
  cp -r packages/playwright-core/lib/cjs/webpack/traceViewer/ trace.playwright.dev/docs/next/
  echo "Updated canary version"
elif [[ "${RELEASE_CHANNEL}" == "--beta" ]]; then
  rm -rf trace.playwright.dev/docs/beta/
  cp -r packages/playwright-core/lib/cjs/webpack/traceViewer/ trace.playwright.dev/docs/beta/
